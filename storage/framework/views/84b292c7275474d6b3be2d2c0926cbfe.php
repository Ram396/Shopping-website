<!DOCTYPE html>
<html lang="<?php echo e($locale); ?>" dir="<?php echo e($localeDir); ?>">
	<head>
		<meta charset="utf-8">
		...
		<?php if( config('app.debug') !== true ): ?>
			<meta http-equiv="Content-Security-Policy" content="default-src 'self' data: blob: https://cdnjs.cloudflare.com https://cdn.jsdelivr.net; <?php echo e(config( 'shop.csp.backend', 'style-src \'unsafe-inline\' \'self\' https://cdnjs.cloudflare.com https://cdn.jsdelivr.net; script-src \'unsafe-eval\' \'self\' https://cdnjs.cloudflare.com https://cdn.jsdelivr.net; connect-src \'self\' https://*.deepl.com https://api.openai.com; img-src \'self\' data: blob: https://cdnjs.cloudflare.com https://cdn.jsdelivr.net https://*.tile.openstreetmap.org https://aimeos.org; frame-src https://www.youtube.com https://player.vimeo.com' )); ?>">
		<?php endif; ?>

		<title>Aimeos administration interface</title>

		<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.css">
		<?php if( $localeDir == 'rtl' ): ?>
		...
		<style nonce="<?php echo e(app( 'aimeos.context' )->get( false )->nonce()); ?>">
	...
	<body class="<?php echo e($theme); ?>">
		<div class="app-menu">
			...
			<div class="app-menu-end">
				...
				<form id="logout-form" action="<?php echo e(airoute( 'logout', ['locale' => Request::get( 'locale', app()->getLocale() )] )); ?>" method="POST"><?php echo e(csrf_field()); ?><i class="icon btn-theme light-mode fa"></i><i class="icon btn-theme dark-mode fa"></i><button class="icon logout"></button></form>
			</div>
		</div>
